...
public class Appointment extends JFrame {
	...
	public static void main(String[]args) {
     ...
     public Appointment() {
    	 ...
    	 JLabel lblPersonRequestingAppointment = new JLabel("Person Requseting Appointment");
    	 ...
    	 textField.setBounds(200,8,161,20);
    	 panel.add(textField);
    	 ...
    	 rdbtnOther.setBounds(324,42,75,23);
    	 ...
    	 rdbtnFollowUp.setBounds(297,7,109,23);
    	 ...
    	 rdbtnNew.addActionListener(new ActionListener() {
    		 public void actionPerfromed(ActionListener arg0) {
    			 panel_1.setVisible(false);
    		 }
    	 ...
    	 textField_3.setBounds(241,164,161,20);
    	 contentPane.add(textField_3);
    	 textField_3.setColumns(10);
    	 
    	 JTextPane textPane = new JTextPane();
    	 textPane.setBounds(241,198,112,14);
    	 contentPane.add(textPane);
    	 
    	 JLabel lblDesired = new JLabel("Desired Date");
    	 lblDesired.setBounds(10,392,112,14);
    	 ...
    	 lblDesired.setBounds(241,386,161,20);
